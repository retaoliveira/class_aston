---
title: "Exercício 1 - Análise de dados para gestão organizacional"
...
2. Corrija os problemas de códigos nos respectivos chunks. 

3. Rode o arquivo .Rmd por meio do comando a seguir, substituindo o nome do arquivo pelo endereço completo em seu computador. 

`rmarkdown::render("ENDEREÇAMENTODOARQUIVO.Rmd")`

4. Salve o .pdf e submeta-o por meio desta tarefa. 
